...
var state_1 = require("./scripts/state"); //Anime.js


var anime_es_js_1 = __importDefault(require("animejs/lib/anime.es.js")); //Variables
...
var toggle = function toggle() {
  button.onclick = function () {
    return toggleService.send('TOGGLE');
  };
};
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "45811" + '/');
